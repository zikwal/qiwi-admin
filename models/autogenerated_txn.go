...
// CommentEq is an autogenerated method
// nolint: dupl
func (qs TxnQuerySet) CommentEq(comment string) TxnQuerySet {
	return qs.w(qs.db.Where("comment = ?", comment))
}

// CommentIn is an autogenerated method
// nolint: dupl
func (qs TxnQuerySet) CommentIn(comment string, commentRest ...string) TxnQuerySet {
	iArgs := []interface{}{comment}
	for _, arg := range commentRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("comment IN (?)", iArgs))
}

// CommentNe is an autogenerated method
// nolint: dupl
func (qs TxnQuerySet) CommentNe(comment string) TxnQuerySet {
	return qs.w(qs.db.Where("comment != ?", comment))
}

// CommentNotIn is an autogenerated method
// nolint: dupl
func (qs TxnQuerySet) CommentNotIn(comment string, commentRest ...string) TxnQuerySet {
	iArgs := []interface{}{comment}
	for _, arg := range commentRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("comment NOT IN (?)", iArgs))
}
...
// SetComment is an autogenerated method
// nolint: dupl
func (u TxnUpdater) SetComment(comment string) TxnUpdater {
	u.fields[string(TxnDBSchema.Comment)] = comment
	return u
}
...
// nolint: dupl
func (u TxnUpdater) SetDeletedAt(deletedAt *time.Time) TxnUpdater {
	u.fields[string(TxnDBSchema.DeletedAt)] = deletedAt
	return u
}
...
// nolint: dupl
func (u TxnUpdater) UpdateNum() (int64, error) {
...
func (f txnDBSchemaField) String() string {
	return string(f)
}
...
var TxnDBSchema = struct {
	...
	Comment:       txnDBSchemaField("comment"),
