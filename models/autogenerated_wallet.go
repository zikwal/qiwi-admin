...
// nolint: dupl
func (u WalletUpdater) SetDeletedAt(deletedAt *time.Time) WalletUpdater {
	u.fields[string(WalletDBSchema.DeletedAt)] = deletedAt
	return u
}
...
// nolint: dupl
func (u WalletUpdater) UpdateNum() (int64, error) {
...
func (f walletDBSchemaField) String() string {
	return string(f)
}
